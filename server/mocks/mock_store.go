...
// Source: github.com/mattermost/mattermost-plugin-servicenow-virtual-agent/server/plugin (interfaces: Store)
...
func (mr *MockStoreMockRecorder) DeleteUserTokenOnEncryptionSecretChange() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUserTokenOnEncryptionSecretChange", reflect.TypeOf((*MockStore)(nil).DeleteUserTokenOnEncryptionSecretChange))
}
